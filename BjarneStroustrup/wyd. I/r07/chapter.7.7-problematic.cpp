...
//
// To jest przyk³adowy kod z podrozdzia³u 7.7 "Odzyskiwanie sprawnoœci po wyst¹pieniu b³êdu" ksi¹¿ki 
...
void clean_up_mess()           // naiwne rozwi¹zanie
{ 
    while (true) {             // Pomija znaki a¿ do napotkania znaku drukowania.
        Token t = ts.get();
