...
//
// To jest przyk³adowy kod z podrozdzia³u 12.7.10 „Jeszcze wiêcej grafik" ksi¹¿ki
...
{ 
    ...
    Image ii(Point(100,50),"image.jpg"); // Obraz jpg o wymiarach 400*212.
    win.attach(ii);
    ii.move(100,200);
    ...
    ostringstream oss;
    oss << "Rozmiar ekranu: " << x_max() << "*" << y_max()
        << "; rozmiar okna: " << win.x_max() << "*" << win.y_max();
    Text sizes(Point(100,20),oss.str());

    Image cal(Point(225,225),"snow_cpp.gif"); // Obraz gif o wymiarach 320*240.
    cal.set_mask(Point(40,40),200,150);       // Wyœwietla œrodkow¹ czêœæ obrazu.
