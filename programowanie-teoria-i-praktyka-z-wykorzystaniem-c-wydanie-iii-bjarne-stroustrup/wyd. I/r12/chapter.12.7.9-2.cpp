...
//
// To jest przyk³adowy kod z podrozdzia³u 12.7.9 "Obrazy" ksi¹¿ki
...
{ 
    ...
    Image ii(Point(100,50),"image.jpg"); // Obraz jpg o wymiarach 400*212 pikseli.
    win.attach(ii);
    ii.move(100,200);

    win.set_label("Kanwa nr 11");
