...
//
// To jest przyk³adowy kod z podrozdzia³u 24.6.2 „Wybór elementu centralnego” ksi¹¿ki
...
void elim_with_partial_pivot(Matrix& A, Vector& b)
{
    ...
    for (Index j = 0; j < n; ++j) {
        ...
        // Zamienia wiersze miejscami, jeœli znajdzie lepszy punkt centralny:
        if (pivot_row != j) {
        ...
        for (Index i = j + 1; i < n; ++i) {
            ...
            if (pivot==0) error("Nie da siê rozwi¹zaæ: pivot==0");
...
Vector back_substitution(const Matrix& A, const Vector& b)
{
    ...
    for (Index i = n - 1; i >= 0; --i) {
        ...
        if (double m = A(i, i))
            ...
            error("Nie da siê rozwi¹zaæ: podczas podstawiania wstecz wyst¹pi³ element zerowy na przek¹tnej.");
    }
